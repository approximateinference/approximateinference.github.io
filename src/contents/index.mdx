...
ProbML is a venue for researchers to gather and exchange ideas on probabilistic AI, especially (but not limited to) Bayesian techniques. This ranges from approximate Bayesian inference to probabilistic inference to Bayesian statistics.
The Symposium on Probabilistic Machine Learning (ProbML 2026, formerly Advances in Approximate Bayesian Inference) will be held on July 5, 2026 in Seoul at Seoul Trade Exhibition & Convention (SETEC), co-located with ICML 2026. This year's symposium features an expanded scope with **two primary areas of focus**:
