...
1. Create a new page in `src/pages`, e.g. `new_page.astro`. You can copy-paste the existing page. Note that, the filename is important since it reflects the site endpoint: `new_page.astro` translates into `https://approximateinference.org/new_page`.
